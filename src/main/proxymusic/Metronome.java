 ...
 *           &lt;element ref="{}per-minute" minOccurs="0"/>
 *           &lt;sequence>
 *             &lt;element ref="{}beat-unit"/>
 *             &lt;element ref="{}beat-unit-dot" maxOccurs="unbounded" minOccurs="0"/>
 *           &lt;/sequence>
 *         &lt;/sequence>
 *       &lt;/sequence>
...
@XmlType(name = "", propOrder = {
    "perMinuteAndBeatUnitAndBeatUnitDot"
})
@XmlRootElement(name = "metronome")
public class Metronome {

    @XmlElements({
        @XmlElement(name = "beat-unit-dot", type = BeatUnitDot.class),
        @XmlElement(name = "per-minute", type = PerMinute.class),
        @XmlElement(name = "beat-unit", type = BeatUnit.class)
    })
    protected List<Object> perMinuteAndBeatUnitAndBeatUnitDot;
    @XmlAttribute
    ...
    /**
     * Gets the value of the perMinuteAndBeatUnitAndBeatUnitDot property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the perMinuteAndBeatUnitAndBeatUnitDot property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPerMinuteAndBeatUnitAndBeatUnitDot().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getPerMinuteAndBeatUnitAndBeatUnitDot() {
        if (perMinuteAndBeatUnitAndBeatUnitDot == null) {
            perMinuteAndBeatUnitAndBeatUnitDot = new ArrayList<Object>();
        }
        return this.perMinuteAndBeatUnitAndBeatUnitDot;
    }
